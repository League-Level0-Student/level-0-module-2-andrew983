...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			paperImage = new ImageIcon(getClass().getResource("download-1.jpg"));
			scissorsImage = new ImageIcon(getClass().getResource("download-2.jpg"));
 ...
 int OS = gen.nextInt(3);
        //3. Change the value of opponentSelection to be a random number between 0 and 2;
        int opponentSelection = OS;
        
        //4. Run the program again. Is the result different? yes
